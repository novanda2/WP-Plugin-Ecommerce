...
<body>
    <div class="antialiased sans-serif bg-gray-200 min-h-screen pt-12">
        <div class="container mx-auto py-6 px-4" x-data="datatables()" x-cloak>
            <form x-show="detailModal.isOpen" id="detailModal" class="fixed w-screen h-screen z-50 inset-0 flex justify-center items-center">
                ...
                <div class="relative z-10 w-9/12 max-w-screen overflow-auto">
                    ...
                    <template x-for="user in users" :key="user.orderId">
                        <div x-show="user.orderId === detailModal.id" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                            ...
                            <div class="-mx-3 md:flex mb-6">
                                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text" placeholder="Jane" disabled>
                                </div>
                            ...
                            <div class="-mx-3 md:flex mb-6">
                                <div class="md:w-full px-3">
                                    ...
                                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" type="password" placeholder="******************" autocomplete>
        ...
        const datatables = () => {
            return {
                ...
                handleOpenDetailModal(id) {
                    ...
                    console.log(this.detailModal.id)
