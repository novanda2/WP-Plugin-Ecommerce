...
?>
    ...
    <div class="nvn-metabox">
      <div class="nvn-metabox__product-image">
        <h4 class="nvn-metabox__title">Product Images <small>(multiple)</small></h4>
        <input type="hidden" class="nvn-uploader__input-images" name="product_images" value="<?= $product_images; ?>">
      ...
      <div class="nvn-metabox__product-price">
        ...
        <input type="hidden" class="nvn-metabox__product-price__input-value" value="<?= $product_price; ?>" name="product_price">
